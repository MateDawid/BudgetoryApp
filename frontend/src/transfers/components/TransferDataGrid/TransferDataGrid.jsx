...

    {
      ...
      renderCell: (params) => (
        <span
          style={{
            color:
              transferType === TransferTypes.EXPENSE ? '#BD0000' : '#008000',
            fontWeight: 'bold',
          }}
        >
    ...
    <>
      ...
      >
        <StyledDataGrid
          ...
          onRowSelectionModelChange={(selectedRowsIds) =>
      ...
      <TransferEditModal
        ...
        setEditedTransfer={setEditedTransfer}
      />
      <TransferDeleteModal
        apiUrl={apiUrl}
        transferType={transferType}
        ...
        setDeletedTransferId={setDeletedTransferId}
      />
    </>
  );
};
