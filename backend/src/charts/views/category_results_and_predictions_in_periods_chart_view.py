...
from charts.views.swagger_setup import CATEGORY_RESULTS_AND_PREDICTIONS_IN_PERIODS_ACTIONS, CHARTS_TAG
...
@swagger_tag(tag=CHARTS_TAG, action_params=CATEGORY_RESULTS_AND_PREDICTIONS_IN_PERIODS_ACTIONS)
